...
public record ResetPasswordRequest(
        ...
        @Size(max = MAX_LENGTH, message = "Confirm new password must be 128 characters or fewer")
        String confirmNewPassword
) {
    @Override public String toString() { return "ResetPasswordRequest[token=<redacted>, passwords=<redacted>]"; }
}
